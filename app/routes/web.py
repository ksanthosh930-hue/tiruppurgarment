...
def robots():
    ...
    return response
    for cat in KnowledgeCategory.query.all():
        pages.append({'loc': f"{base_url}/knowledge/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.6'})
        pages.append({'loc': f"{base_url}/ta/knowledge/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.5'})
        pages.append({'loc': f"{base_url}/ta-en/knowledge/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.5'})
        
    for cat in ToolCategory.query.all():
        pages.append({'loc': f"{base_url}/tools/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.7'})
        pages.append({'loc': f"{base_url}/ta/tools/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.6'})
        pages.append({'loc': f"{base_url}/ta-en/tools/category/{cat.slug}", 'changefreq': 'weekly', 'priority': '0.6'})
